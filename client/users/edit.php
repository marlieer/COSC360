...
<form name="edituserform"  method="post" action="http://randyconnolly.com/tests/process.php" onsubmit="return validateUserUpdate()">
	...
	<legend>Edit User</legend>
		...
		<p>
			...
			<input class="input form-control" type="text" name="lname" id="lname" value="Ngo"/>
		</p>
		<p>
			<label>Birthday</label>
			<input class="input form-control" type="date" name="birth" id="birth" value="1997-01-01"/>
		</p>
		<p>
			<label>Email</label>
			<input class="input form-control" type="text" name="email" id="email" value="test123@gmail.com"/>
        </p>
        <p>
            <small>
		...
		<p>
			...
			<input class="input form-control" type="password" name="oldpass" id="oldpass" value="1234Abcd"/>
        </p>
        <p>
